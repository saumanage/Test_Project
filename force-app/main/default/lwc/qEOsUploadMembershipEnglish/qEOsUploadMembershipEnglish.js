...
import { OMNIDEF } from './qEOsUploadMembershipEnglish_def.js';
import tmpl from './qEOsUploadMembershipEnglish.html';
import tmpl_nds from './qEOsUploadMembershipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsUploadMembershipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
