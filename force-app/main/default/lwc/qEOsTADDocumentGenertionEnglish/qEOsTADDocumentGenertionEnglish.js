...
import { OMNIDEF } from './qEOsTADDocumentGenertionEnglish_def.js';
import tmpl from './qEOsTADDocumentGenertionEnglish.html';
import tmpl_nds from './qEOsTADDocumentGenertionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsTADDocumentGenertionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
