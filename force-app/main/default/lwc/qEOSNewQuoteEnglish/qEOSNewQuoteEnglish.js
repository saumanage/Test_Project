...
import { OMNIDEF } from './qEOSNewQuoteEnglish_def.js';
import tmpl from './qEOSNewQuoteEnglish.html';
import tmpl_nds from './qEOSNewQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOSNewQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
