...
import { OMNIDEF } from './qEOsContractDocumentGenerationEnglish_def.js';
import tmpl from './qEOsContractDocumentGenerationEnglish.html';
import tmpl_nds from './qEOsContractDocumentGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsContractDocumentGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
