...
import { OMNIDEF } from './qECloseQuoteEnglish_def.js';
import tmpl from './qECloseQuoteEnglish.html';
import tmpl_nds from './qECloseQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qECloseQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
