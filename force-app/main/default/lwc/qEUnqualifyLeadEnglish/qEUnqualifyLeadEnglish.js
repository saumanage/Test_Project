...
import { OMNIDEF } from './qEUnqualifyLeadEnglish_def.js';
import tmpl from './qEUnqualifyLeadEnglish.html';
import tmpl_nds from './qEUnqualifyLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEUnqualifyLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
