...
import { OMNIDEF } from './qEOsUpdateMemberEnglish_def.js';
import tmpl from './qEOsUpdateMemberEnglish.html';
import tmpl_nds from './qEOsUpdateMemberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsUpdateMemberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
