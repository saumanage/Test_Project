...
import { OMNIDEF } from './qEOsUpdateSubscriberEnglish_def.js';
import tmpl from './qEOsUpdateSubscriberEnglish.html';
import tmpl_nds from './qEOsUpdateSubscriberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsUpdateSubscriberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
