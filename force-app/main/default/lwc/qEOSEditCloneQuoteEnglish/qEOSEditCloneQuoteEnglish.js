...
import { OMNIDEF } from './qEOSEditCloneQuoteEnglish_def.js';
import tmpl from './qEOSEditCloneQuoteEnglish.html';
import tmpl_nds from './qEOSEditCloneQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOSEditCloneQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
