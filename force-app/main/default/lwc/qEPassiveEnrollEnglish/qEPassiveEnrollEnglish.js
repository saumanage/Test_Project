...
import { OMNIDEF } from './qEPassiveEnrollEnglish_def.js';
import tmpl from './qEPassiveEnrollEnglish.html';
import tmpl_nds from './qEPassiveEnrollEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEPassiveEnrollEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
