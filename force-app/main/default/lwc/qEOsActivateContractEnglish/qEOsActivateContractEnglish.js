...
import { OMNIDEF } from './qEOsActivateContractEnglish_def.js';
import tmpl from './qEOsActivateContractEnglish.html';
import tmpl_nds from './qEOsActivateContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsActivateContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
