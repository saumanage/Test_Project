...
import { OMNIDEF } from './qEOSApproveMembershipEnglish_def.js';
import tmpl from './qEOSApproveMembershipEnglish.html';
import tmpl_nds from './qEOSApproveMembershipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOSApproveMembershipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
