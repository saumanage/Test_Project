...
import { OMNIDEF } from './qEOsWorkflowEnglish_def.js';
import tmpl from './qEOsWorkflowEnglish.html';
import tmpl_nds from './qEOsWorkflowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsWorkflowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
