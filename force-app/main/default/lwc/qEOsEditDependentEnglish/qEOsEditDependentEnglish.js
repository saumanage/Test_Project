...
import { OMNIDEF } from './qEOsEditDependentEnglish_def.js';
import tmpl from './qEOsEditDependentEnglish.html';
import tmpl_nds from './qEOsEditDependentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsEditDependentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
