...
import { OMNIDEF } from './qEOsTerminateMemberEnglish_def.js';
import tmpl from './qEOsTerminateMemberEnglish.html';
import tmpl_nds from './qEOsTerminateMemberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsTerminateMemberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
