...
import { OMNIDEF } from './qEOsRateFactorEnglish_def.js';
import tmpl from './qEOsRateFactorEnglish.html';
import tmpl_nds from './qEOsRateFactorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsRateFactorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
