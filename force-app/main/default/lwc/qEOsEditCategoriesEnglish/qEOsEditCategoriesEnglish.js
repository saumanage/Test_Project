...
import { OMNIDEF } from './qEOsEditCategoriesEnglish_def.js';
import tmpl from './qEOsEditCategoriesEnglish.html';
import tmpl_nds from './qEOsEditCategoriesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsEditCategoriesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
