...
import { OMNIDEF } from './qEOsAddDependentsEnglish_def.js';
import tmpl from './qEOsAddDependentsEnglish.html';
import tmpl_nds from './qEOsAddDependentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsAddDependentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
