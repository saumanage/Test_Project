...
import { OMNIDEF } from './qEOsAcceptQuoteEnglish_def.js';
import tmpl from './qEOsAcceptQuoteEnglish.html';
import tmpl_nds from './qEOsAcceptQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsAcceptQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
