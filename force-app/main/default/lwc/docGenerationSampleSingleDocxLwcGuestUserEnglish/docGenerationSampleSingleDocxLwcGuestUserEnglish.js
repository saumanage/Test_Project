...
import { OMNIDEF } from './docGenerationSampleSingleDocxLwcGuestUserEnglish_def.js';
import tmpl from './docGenerationSampleSingleDocxLwcGuestUserEnglish.html';
import tmpl_nds from './docGenerationSampleSingleDocxLwcGuestUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleSingleDocxLwcGuestUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
