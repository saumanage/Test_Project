...
import { OMNIDEF } from './qEOsInitiateAutoRenewalEnglish_def.js';
import tmpl from './qEOsInitiateAutoRenewalEnglish.html';
import tmpl_nds from './qEOsInitiateAutoRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsInitiateAutoRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
