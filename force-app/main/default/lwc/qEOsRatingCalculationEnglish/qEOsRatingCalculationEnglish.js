...
import { OMNIDEF } from './qEOsRatingCalculationEnglish_def.js';
import tmpl from './qEOsRatingCalculationEnglish.html';
import tmpl_nds from './qEOsRatingCalculationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsRatingCalculationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
