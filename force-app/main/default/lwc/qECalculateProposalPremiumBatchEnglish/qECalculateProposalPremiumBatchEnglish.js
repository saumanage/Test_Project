...
import { OMNIDEF } from './qECalculateProposalPremiumBatchEnglish_def.js';
import tmpl from './qECalculateProposalPremiumBatchEnglish.html';
import tmpl_nds from './qECalculateProposalPremiumBatchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qECalculateProposalPremiumBatchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
