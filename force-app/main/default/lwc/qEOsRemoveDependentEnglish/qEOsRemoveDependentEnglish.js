...
import { OMNIDEF } from './qEOsRemoveDependentEnglish_def.js';
import tmpl from './qEOsRemoveDependentEnglish.html';
import tmpl_nds from './qEOsRemoveDependentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsRemoveDependentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
