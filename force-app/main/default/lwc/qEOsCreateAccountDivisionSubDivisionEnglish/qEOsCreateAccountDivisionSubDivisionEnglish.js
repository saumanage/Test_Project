...
import { OMNIDEF } from './qEOsCreateAccountDivisionSubDivisionEnglish_def.js';
import tmpl from './qEOsCreateAccountDivisionSubDivisionEnglish.html';
import tmpl_nds from './qEOsCreateAccountDivisionSubDivisionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsCreateAccountDivisionSubDivisionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
