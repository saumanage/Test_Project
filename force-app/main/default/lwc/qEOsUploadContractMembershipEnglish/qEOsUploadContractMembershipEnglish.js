...
import { OMNIDEF } from './qEOsUploadContractMembershipEnglish_def.js';
import tmpl from './qEOsUploadContractMembershipEnglish.html';
import tmpl_nds from './qEOsUploadContractMembershipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsUploadContractMembershipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
