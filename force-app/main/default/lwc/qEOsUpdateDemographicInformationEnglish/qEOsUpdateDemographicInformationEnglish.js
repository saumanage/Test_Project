...
import { OMNIDEF } from './qEOsUpdateDemographicInformationEnglish_def.js';
import tmpl from './qEOsUpdateDemographicInformationEnglish.html';
import tmpl_nds from './qEOsUpdateDemographicInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsUpdateDemographicInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
