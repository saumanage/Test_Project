...
import { OMNIDEF } from './qEInitiateContractAutoRenewalEnglish_def.js';
import tmpl from './qEInitiateContractAutoRenewalEnglish.html';
import tmpl_nds from './qEInitiateContractAutoRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEInitiateContractAutoRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
