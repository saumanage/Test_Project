...
import { OMNIDEF } from './qEOsGenerateProposalEnglish_def.js';
import tmpl from './qEOsGenerateProposalEnglish.html';
import tmpl_nds from './qEOsGenerateProposalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsGenerateProposalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
