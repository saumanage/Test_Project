...
import { OMNIDEF } from './qEOsEditGroupSubGroupEnglish_def.js';
import tmpl from './qEOsEditGroupSubGroupEnglish.html';
import tmpl_nds from './qEOsEditGroupSubGroupEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsEditGroupSubGroupEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
