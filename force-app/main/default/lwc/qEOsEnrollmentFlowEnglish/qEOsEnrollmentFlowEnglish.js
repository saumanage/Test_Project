...
import { OMNIDEF } from './qEOsEnrollmentFlowEnglish_def.js';
import tmpl from './qEOsEnrollmentFlowEnglish.html';
import tmpl_nds from './qEOsEnrollmentFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsEnrollmentFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
