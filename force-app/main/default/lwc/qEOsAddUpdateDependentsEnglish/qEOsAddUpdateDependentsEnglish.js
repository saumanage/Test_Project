...
import { OMNIDEF } from './qEOsAddUpdateDependentsEnglish_def.js';
import tmpl from './qEOsAddUpdateDependentsEnglish.html';
import tmpl_nds from './qEOsAddUpdateDependentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsAddUpdateDependentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
