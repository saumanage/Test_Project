...
import { OMNIDEF } from './qEOsRehireSubscriberEnglish_def.js';
import tmpl from './qEOsRehireSubscriberEnglish.html';
import tmpl_nds from './qEOsRehireSubscriberEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsRehireSubscriberEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
