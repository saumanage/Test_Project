...
import { OMNIDEF } from './qEApplicationWorkflowActionEnglish_def.js';
import tmpl from './qEApplicationWorkflowActionEnglish.html';
import tmpl_nds from './qEApplicationWorkflowActionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEApplicationWorkflowActionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
