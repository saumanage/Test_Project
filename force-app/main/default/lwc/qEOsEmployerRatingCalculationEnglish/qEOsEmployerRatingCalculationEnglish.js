...
import { OMNIDEF } from './qEOsEmployerRatingCalculationEnglish_def.js';
import tmpl from './qEOsEmployerRatingCalculationEnglish.html';
import tmpl_nds from './qEOsEmployerRatingCalculationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsEmployerRatingCalculationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
