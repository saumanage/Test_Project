...
import { OMNIDEF } from './qEOsTransactionMassApprovalEnglish_def.js';
import tmpl from './qEOsTransactionMassApprovalEnglish.html';
import tmpl_nds from './qEOsTransactionMassApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsTransactionMassApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
