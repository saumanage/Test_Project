...
import { OMNIDEF } from './qEOsLifeEventEnglish_def.js';
import tmpl from './qEOsLifeEventEnglish.html';
import tmpl_nds from './qEOsLifeEventEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsLifeEventEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
