...
import { OMNIDEF } from './qE_LargeGroupPlansSetupEnglish_def.js';
import tmpl from './qE_LargeGroupPlansSetupEnglish.html';
import tmpl_nds from './qE_LargeGroupPlansSetupEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qE_LargeGroupPlansSetupEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
