...
import { OMNIDEF } from './qEOsCreateSubGroupEnglish_def.js';
import tmpl from './qEOsCreateSubGroupEnglish.html';
import tmpl_nds from './qEOsCreateSubGroupEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsCreateSubGroupEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
