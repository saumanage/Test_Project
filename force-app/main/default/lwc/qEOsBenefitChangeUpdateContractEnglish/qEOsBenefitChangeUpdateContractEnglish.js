...
import { OMNIDEF } from './qEOsBenefitChangeUpdateContractEnglish_def.js';
import tmpl from './qEOsBenefitChangeUpdateContractEnglish.html';
import tmpl_nds from './qEOsBenefitChangeUpdateContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsBenefitChangeUpdateContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
