...
import { OMNIDEF } from './qEOsRateFactorV2English_def.js';
import tmpl from './qEOsRateFactorV2English.html';
import tmpl_nds from './qEOsRateFactorV2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsRateFactorV2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
