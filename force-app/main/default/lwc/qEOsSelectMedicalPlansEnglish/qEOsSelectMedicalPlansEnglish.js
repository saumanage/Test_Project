...
import { OMNIDEF } from './qEOsSelectMedicalPlansEnglish_def.js';
import tmpl from './qEOsSelectMedicalPlansEnglish.html';
import tmpl_nds from './qEOsSelectMedicalPlansEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsSelectMedicalPlansEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
