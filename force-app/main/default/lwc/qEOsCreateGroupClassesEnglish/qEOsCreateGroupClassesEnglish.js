...
import { OMNIDEF } from './qEOsCreateGroupClassesEnglish_def.js';
import tmpl from './qEOsCreateGroupClassesEnglish.html';
import tmpl_nds from './qEOsCreateGroupClassesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEOsCreateGroupClassesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
