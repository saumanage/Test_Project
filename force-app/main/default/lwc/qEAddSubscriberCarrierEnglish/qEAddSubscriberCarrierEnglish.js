...
import { OMNIDEF } from './qEAddSubscriberCarrierEnglish_def.js';
import tmpl from './qEAddSubscriberCarrierEnglish.html';
import tmpl_nds from './qEAddSubscriberCarrierEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qEAddSubscriberCarrierEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
