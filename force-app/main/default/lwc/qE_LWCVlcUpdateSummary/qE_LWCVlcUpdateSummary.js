...
export default class QE_LWCVlcUpdateSummary extends OmniscriptBaseMixin(LightningElement) {

    @track selectedPlans;
    @track summary;
    @track dependentPlans;
    @track childs;
    @track records;
    ...
    // get getSelectedPlansArr() {
    //     return this.selectedPlansArr.length;
    // }

    connectedCallback() {
        console.log(JSON.stringify(this.omniJsonData));
        // let omniJsonDataO = JSON.parse(JSON.stringify(this.omniJsonData));
        // this.selectedPlans = this.convertArray(omniJsonDataO.smallGroupSelection.selectedPlans);
        // this.summary = omniJsonDataO;
        // this.dependentPlans =  this.convertArray(omniJsonDataO.response);
        // this.childs = this.convertArray(omniJsonDataO.children);
        // this.records = this.convertArray(this.summary.PediatricDentalPlans.listProducts.records);
        ...
        this.pediatricPlansArr = this.summary.PediatricDentalPlans.listProducts ? this.convertArray(this.summary.PediatricDentalPlans.listProducts.records) : [];
        // this.summary.reasonForChange.hireDateFormatted = this.toDate(this.summary.reasonForChange.hireDate);
        this.summary.effectiveDateFormulaFormatted = this.toDate(this.summary.reasonForChange.effectiveDate);
        // this.summary.reasonForChange.DateOfEventFormatted = this.summary.reasonForChange ? this.toDate(this.summary.reasonForChange.DateOfEvent) : '';
        ...
        this.summary.reasonForChange.reasonForEnrollmentFormatted = this.splitspaceCamelcase(this.summary.reasonForChange.reasonForEnrollment);
        ...
        this.dependenRepeatable = this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans);
        this.dependenRepeatable = this.dependenRepeatable.map((dependent, i) => {
            return {
                ...
                getDpPlan: this.omniJsonData.choosePlansDependents ? this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i] : '',
                getPedDentalValidation: this.omniJsonData.choosePlansDependents ? this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].pedDentalPlanEnroll != null &&
                    this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].pedDentalPlanEnroll == 'decline' : '',
                getPedDentalPlanEnroll: this.omniJsonData.choosePlansDependents ? this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].pedDentalPlanEnroll == 'enroll' ? 'Enrolled' : this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].pedDentalPlanEnroll == 'decline' ? 'Declined' : '' : '',
                getMedicalPlanEnroll: this.omniJsonData.choosePlansDependents ? this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].medicalPlanEnroll == 'enroll' ? 'Enrolled' : this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].medicalPlanEnroll == 'decline' ? 'Declined' : '-'  : '',
                getDentalPlanEnroll: this.omniJsonData.choosePlansDependents ? this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].dentalPlanEnroll == 'enroll' ? 'Enrolled' : this.convertArray(this.omniJsonData.choosePlansDependents.dependentPlans)[i].dentalPlanEnroll == 'decline' ? 'Declined' : '-' : '',
                // getPcpDep: this.convertArray(this.omniJsonData.PCPSelection.PCPDependents)[i],
                // getCobDep: this.convertArray(this.omniJsonData.CoordinationOfBenefits.COBDependents)[i],
        ...
        console.log("this.dependenRepeatable::::::", this.dependenRepeatable);
